    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold gradient-text mb-4">Blaze Intelligence</h3>
            <p className="text-gray-400 text-sm">
              Revolutionizing sports analytics with AI-powered intelligence and real-time insights.
            </p>
            <div className="flex gap-4 mt-4">
              ...
              <a href="https://github.com/ahump20" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/demo" className="text-gray-400 hover:text-white transition-colors text-sm">Demo</Link></li>
              <li><a href="https://github.com/ahump20/live-sports-scoreboard-api" className="text-gray-400 hover:text-white transition-colors text-sm">API Documentation</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://github.com/ahump20/public-espn-api" className="text-gray-400 hover:text-white transition-colors text-sm">ESPN API</a></li>
              ...
              <li><Link to="/partners" className="text-gray-400 hover:text-white transition-colors text-sm">Partners</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2024 Blaze Intelligence. All rights reserved. | 
